...
(function (global) {
  ...
  const STRINGS = {
    ru: {
      ...
      subscription: 'Подписка', subTerms: '{price} ⭐/мес · напоминание через 30 дней · отмена в любой момент · действует до конца периода',
      cancelAutoRenew: '❌ Отключить напоминания', renewBtn: '🔄 Продлить — {price} ⭐',
      premiumUntil: '✅ Premium до {date}', autoRenewOn: '🔔 Напоминание о продлении через 30 дней ({price} ⭐)', autoRenewOff: '⏸ Напоминания отключены',
      ...
      openTelegram: 'Откройте через Telegram', alreadyPremium: '✅ У вас уже есть Premium!\n\nОтключить напоминания — кнопка ниже.',
      subscribeConfirm: 'Условия подписки Premium:\n\n• {price} ⭐ в месяц\n• Автоматическое напоминание через 30 дней\n• Списание только после оплаты счёта\n• Отмена напоминаний в любой момент\n• После отмены Premium до конца оплаченного периода\n\nСогласны?',
      invoiceSent: 'Счёт отправлен! Проверьте чат с ботом.', errorSubscribe: 'Ошибка. Попробуйте /subscribe в боте.',
      errorBuyChart: 'Ошибка. Попробуйте /buy_chart в боте.', cancelConfirm: 'Отключить напоминания о продлении? Подписка останется до конца оплаченного периода.',
      autoRenewDisabled: '✅ Напоминания отключены',
    ...
    en: {
      ...
      subscription: 'Subscription', subTerms: '{price} ⭐/mo · reminder in 30 days · cancel anytime · valid until period ends',
      cancelAutoRenew: '❌ Disable reminders', renewBtn: '🔄 Renew — {price} ⭐',
      premiumUntil: '✅ Premium until {date}', autoRenewOn: '🔔 Renewal reminder in 30 days ({price} ⭐)', autoRenewOff: '⏸ Reminders disabled',
  ...
  STRINGS.es = {
    ...
    subscription: 'Suscripción', subTerms: '{price} ⭐/mes · recordatorio en 30 días · cancela cuando quieras · válido hasta fin del periodo',
    cancelAutoRenew: '❌ Desactivar recordatorios', renewBtn: '🔄 Renovar — {price} ⭐',
    premiumUntil: '✅ Premium hasta {date}', autoRenewOn: '🔔 Recordatorio en 30 días ({price} ⭐)', autoRenewOff: '⏸ Recordatorios desactivados',
    ...
    openTelegram: 'Abrir vía Telegram', alreadyPremium: '✅ ¡Ya tienes Premium!\n\nDesactiva recordatorios con el botón de abajo.',
    subscribeConfirm: 'Condiciones Premium:\n\n• {price} ⭐ al mes\n• Recordatorio automático en 30 días\n• Cobro solo al pagar la factura\n• Desactiva recordatorios cuando quieras\n• Premium hasta fin del periodo pagado\n\n¿Aceptas?',
    invoiceSent: '¡Factura enviada! Revisa el chat del bot.', errorSubscribe: 'Error. Prueba /subscribe en el bot.',
    errorBuyChart: 'Error. Prueba /buy_chart en el bot.', cancelConfirm: '¿Desactivar recordatorios? La suscripción sigue hasta fin del periodo.',
    autoRenewDisabled: '✅ Recordatorios desactivados',
  ...
  STRINGS.ar = {
    ...
    subscription: 'الاشتراك', subTerms: '{price} ⭐/شهر · تذكير بعد 30 يوماً · إلغاء في أي وقت',
    cancelAutoRenew: '❌ إيقاف التذكيرات', renewBtn: '🔄 تجديد — {price} ⭐',
    premiumUntil: '✅ Premium حتى {date}', autoRenewOn: '🔔 تذكير بعد 30 يوماً ({price} ⭐)', autoRenewOff: '⏸ التذكيرات متوقفة',
    ...
    openTelegram: 'افتح عبر تيليغرام', alreadyPremium: '✅ لديك Premium بالفعل!\n\nأوقف التذكيرات بالزر أدناه.',
    subscribeConfirm: 'شروط Premium:\n\n• {price} ⭐ شهرياً\n• تذكير تلقائي بعد 30 يوماً\n• الخصم فقط عند دفع الفاتورة\n• إيقاف التذكيرات في أي وقت\n\nهل توافق؟',
    invoiceSent: 'تم إرسال الفاتورة! تحقق من محادثة البوت.', errorSubscribe: 'خطأ. جرّب /subscribe في البوت.',
    errorBuyChart: 'خطأ. جرّب /buy_chart في البوت.', cancelConfirm: 'إيقاف تذكيرات التجديد؟ الاشتراك يسري حتى نهاية الفترة.',
    autoRenewDisabled: '✅ تم إيقاف التذكيرات',
